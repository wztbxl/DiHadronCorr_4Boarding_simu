...
static const float FVCUT   = 2.5; //cm
...
Int_t FcsDYBGFilter::Filter( StarGenEvent *mEvent){
	...
	for(unsigned int j=i + 1; j<size; j++){
		...
		cout << Form("FcsDYBGFilter : idx=%3d %3d Pid=%5d %5d E=%6.2f %6.2f M=%6.2f DR=%6.2f res=0x%03x",
			     idx1,idx2,pid1,pid2,
			     p1->GetEnergy(),p2->GetEnergy(),m,dr,res) << endl;
